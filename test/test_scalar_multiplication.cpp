...
// TEST(scalar_multiplication, simple_case)
// {
...
//     transcript_points[1] = 0x1; //bucket 0
//     transcript[0] = 0;
//     transcript[1] = 0;
...
//     }
//     printf("expected[0] = ");
//     g1::element foo = g1::normalize(expected[0]);
//     g1::print(foo);
...
//     std::array<scalar_multiplication::accumulator_temporary, num_points> accumulators;

//     scalar_multiplication::affine_product_runtime_state product_state{ &monomials[0],          &point_pairs[0],
//                                                                        &output_buckets[0], &accumulators[0],  &scratch_space[0],
//                                                                        &bucket_counts[0], &bit_offsets[0],
//                                                                        &point_schedule[0],   num_points, 1, &bucket_empty_status[0]};
...
//     scalar_multiplication::accumulator_temporary* accumulators = static_cast<scalar_multiplication::accumulator_temporary*>(aligned_alloc(64, sizeof(scalar_multiplication::accumulator_temporary) * num_points));

//     scalar_multiplication::affine_product_runtime_state product_state{ monomials,        point_pairs,   scratch_points, accumulators,
...
//         monomials, point_pairs, scratch_points, accumulators, scratch_field, bucket_counts, &bit_offsets[0], state.wnaf_table, num_points, static_cast<uint32_t>(num_buckets), bucket_empty_status
//     };
...
//     scalar_multiplication::affine_product_runtime_state product_state{
//         monomials, monomials, monomials, accumulators, nullptr, bucket_counts, &bit_offsets[0], state.wnaf_table, num_points, static_cast<uint32_t>(num_buckets), bucket_empty_status
//     };
